...
public class ListaDupla {
	...
	public void concatenarListas(ListaDupla Lista1 , ListaDupla Lista2){
		...
		{
			Lista2.aux = inicio;
			while (Lista2.aux !=null){
				
				System.out.println(Lista2.aux.num);
				Lista1.inserirInicio(Lista2.aux.num);
				Lista2.aux = Lista2.aux.prox;
			}
		}
	}
